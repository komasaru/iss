...
module const
  ...
  integer(SP),  parameter :: UID_J   = 13                       ! JSON 用 Unit ID
  character(*), parameter :: F_TLE   = "data/tle_iss_nasa.txt"  ! TLE ファイル
  character(*), parameter :: F_EOP   = "data/eop.csv"           ! EOP ファイル
  character(*), parameter :: F_DAT   = "file/Leap_Second.dat"   ! DAT ファイル
  character(*), parameter :: F_JSON  = "data/iss.json"          ! JSON ファイル
